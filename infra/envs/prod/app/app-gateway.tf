    ...
    template {
      ...
      spec {
        ...
        container {
          ...
          env { name = "JAVA_TOOL_OPTIONS", value = "-Dspring.profiles.active=prod -XX:InitialRAMPercentage=75.0 -XX:MaxRAMPercentage=75.0 -XX:MinRAMPercentage=75.0" }
        ...
        # Redis 통신 사이드카 (RateLimiter 등 용도)
        container {
          name  = "stunnel"
